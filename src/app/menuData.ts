export const foodMenu = [
  ...
  {
    category: "BEER/MALT DRINKS",
    image: "/images/beer.jpeg",
    items: [
      { name: "Star Lite", price: 1500 },
      { name: "Life", price: 1500 },
      { name: "Gulder", price: 2000 },
      { name: "Star Radler", price: 1500 },
      { name: "Heineken", price: 2000 },
      { name: "Ace Roots", price: 1500 },
      { name: "Desperados", price: 2000 },
      { name: "33 Export", price: 1500 },
      { name: "Tiger", price: 1500 },
      { name: "Small Bottle Smirnoff", price: 1500 },
      { name: "Small Legend", price: 1500 },
      { name: "Big Legend", price: 2000 },
      { name: "Guinness Stout", price: 2000 },
      { name: "Guinness Extra Smooth", price: 2000 },
      { name: "Goldberg", price: 1500 },
      { name: "Trophy Lager", price: 1500 },
      { name: "Orijin Beer (Bottle)", price: 2000 },
      { name: "Budweiser", price: 2000 },
      { name: "Hero", price: 2000 },
      { name: "Zeva", price: 1500 },
      { name: "Smirnoff (Can)", price: 2000 },
      { name: "Smirnoff (Big Bottle)", price: 2000 },
      { name: "Bottle Malt", price: 1000 },
      { name: "Can Guinness Malt", price: 1500 },
      { name: "Coke (Plastic)", price: 1000 },
      { name: "Coke (Bottle)", price: 1000 },
      { name: "Orijin (Can)", price: 1500 },
      { name: "Orijin Bitter", price: 2000 },
      { name: "Trophy Stout", price: 2000 },
      { name: "Amstel Malt", price: 1500 },
      { name: "Malta Guinness (Bottle)", price: 1500 },
